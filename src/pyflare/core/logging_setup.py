...
def setup_logging(log_dir: Path, level: str = "INFO") -> None:
    ...
    # 1. Console Handler (Human readable + redacted)
    console_fmt = RedactingConsoleFormatter(
    ...
    file_handler = RotatingFileHandler(
        log_dir / "pyflare.json.log", maxBytes=10_000_000, backupCount=10, encoding="utf-8"
    )
